...
--SELECT * INTO [AX_Asset_Metric_Facts_ALL] FROM [AX_Asset_Metric_Facts_daf]

--INSERT INTO [AX_Asset_Metric_Facts_ALL]
--SELECT * FROM [AX_Asset_Metric_Facts_prd]

truncate table [AX_Asset_Metric_Facts_ALL] 

update AX_Segment_Metric_Facts
set Asset_Master_GroupID=102 


select * from [dbo].[AX_Asset_Metric_Facts_ALL]

insert into [dbo].[AX_Asset_Metric_Facts_ALL]
select * from [AX_Asset_Metric_Facts_DAF]

-------------drop table [AX_Asset_Metric_Facts]
--------------------------------MainQuery Start---------------------
select * into [AX_Asset_Metric_Facts_ALL]
from  [Honda_Repository].dbo.[AX_Asset_Metric_Facts]
where 1=2

select * from [AX_Asset_Metric_Facts_DAF]
from [KITE_Repository].dbo.[AX_Asset_Metric_Facts] where 1=2

 [AX_Asset_Metric_Facts_DAF]
--select * from [Honda_Repository].dbo.[AX_Asset_Metric_Facts]
--select * from [KITE_Repository].dbo.[AX_Asset_Metric_Facts]
--select * from [Lily_Repository].[DBO].[AX_Asset_Metric_Facts_DAF]  
truncate table [AX_Asset_Metric_Facts_ALL]
--------------------------------------------------------------------------------------------------------------------------------------------
insert INTO [AX_Asset_Metric_Facts_ALL] --FROM (
--------------------------STAGE4------------------------------------------------
...
from [dbo].[Asset_Master_Combine] aa
left join (select w.* /*, CASE WHEN w.[WORKTYPE] in('02') and w.jpnum is not null then 'PM'
	...
	else 'OTH' end 'Dev_worktype' */ from [dbo].[Client_workorder_All] w where w.actfinish>='2020-04-01' and w.actfinish<='2022-03-31')
...
from [dbo].[relatedrecord_ALL] r where RELATETYPE='FOLLOWUP' --and year='30-Dec-2020' 
...
---------------------------------------------------------------------------------------------------------------------------
  ...
  select * from [dbo].[client_workorder_ALL1]
...
--------------------------------drop table [dbo].[AX_Asset_Metric_Facts_July]
  ...
  select * from [dbo].[AX_Asset_Metric_Facts_PRD]
  select * from [dbo].[AX_Asset_Metric_Facts_DAF]  
